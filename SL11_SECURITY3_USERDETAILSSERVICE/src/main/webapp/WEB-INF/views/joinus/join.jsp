		...
		<div id="join-form" class="join-form margin-large">
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="id" value="msms" /> <input
			...
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="name" value="ms" />
				</dd>
			</dl>
			<dl class="join-form-row">
			...
			<dl class="join-form-row birthday">
				...
				<dd class="join-form-data">
					<span> <input type="text" id="year" value="1998" />년 <input
						...
						value="12" />일 <input type="hidden" name="birth" id="birth" /> <script>
							$("#day").blur(function() {
								var year = $("#year").val();
								var month = $("#month").val();
								var day = $("#day").val();
			...
			<dl class="join-form-row">
				...
				<dd class="join-form-data">
					<input type="text" name="email" value="ms@com" />
				</dd>
			</dl>
			<dl class="join-form-row">
